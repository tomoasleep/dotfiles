...
- Requirements: @.claude-code/kiro/requirements.md
- Design document: @.claude-code/kiro/design.md

## Your task

### 1. Verify prerequisites

- Check that both `.claude-code/kiro/requirements.md` and `.claude-code/kiro/design.md` exist
...
Create `.claude-code/kiro/tasks.md` with the following structure:
